...
The most recorded and identified species was Little Brown Bat (*Myotis lucifugus*) with a total of`` `r summary_table[11,6]` `` recordings identified, followed by Silver-haired Bats (*Lasionycteris noctivagans*) and Big Brown Bat (*Eptesicus fuscus)* both of which had a total of `` `r summary_table[8,6]` `` recordings identified across the sites and transects (Table 1).
...
Ftable %>%
  kbl(caption = "Table 1: Summary of manual verification conducted in Banff National Park",
      align = c("l", rep("c", ncol(Ftable)-1)),
      escape = FALSE) %>%
...
![Figure 2: Deployment picture for Fenlands](Figures/20240709_084839.jpg)
...
![Figure 3: Sample recordings with echos and multiple bats in single files](Figures/ProblemRecordings.JPG)
