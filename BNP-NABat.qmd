...
![NABat sampling grid (GRTSID: 148842) in Banff National Park for the 2024 field season. The map shows the three stationary acoustic monitoring sites (red dots) and the mobile driving transect (green line) which was conducted twice during the sampling period. The blue dashed line represents the NABat grid cell boundary.](Figures/2024Sites.jpg){#fig-map}
